...
export class Auto1774366665437 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "lot_image" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "s3Key" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "lotId" uuid NOT NULL, CONSTRAINT "PK_bf31b8583d9c2a628effb5e88b8" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."lot_status_enum" AS ENUM('created', 'sold', 'unsold')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."lot_currency_enum" AS ENUM('USD', 'EUR', 'UAH')`,
    );
    await queryRunner.query(
      `CREATE TABLE "lot" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "startPrice" integer NOT NULL, "description" character varying, "status" "public"."lot_status_enum" NOT NULL DEFAULT 'created', "currency" "public"."lot_currency_enum" NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "soldPrice" integer, "auctionId" uuid NOT NULL, "buyerId" uuid, CONSTRAINT "REL_2abf15fd62289693d81d715b5c" UNIQUE ("buyerId"), CONSTRAINT "PK_2ba293e2165c7b93cd766c8ac9b" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "lot" ADD CONSTRAINT "FK_98fe15332f5d4e0da4ab4f1b956" FOREIGN KEY ("auctionId") REFERENCES "auction"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "lot" ADD CONSTRAINT "FK_2abf15fd62289693d81d715b5c3" FOREIGN KEY ("buyerId") REFERENCES "buyer"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "auction" ADD CONSTRAINT "FK_612921ecd63175bd714dc1b1291" FOREIGN KEY ("ownerId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "lot" DROP CONSTRAINT "FK_2abf15fd62289693d81d715b5c3"`,
    );
    await queryRunner.query(
      `ALTER TABLE "lot" DROP CONSTRAINT "FK_98fe15332f5d4e0da4ab4f1b956"`,
    );
    await queryRunner.query(
      `ALTER TABLE "lot_image" DROP CONSTRAINT "FK_36584ef8126a70886c25b5f556f"`,
    );
    ...
    await queryRunner.query(`DROP TABLE "lot_image"`);
